...
return(
<section>
    <div className=" pb-12 pt-6 max-w-8xl px-4 lg:px-20 ">
        <div className="flex flex-wrap-reverse items-center ">
            <div className="w-full lg:w-1/2 lg:pe-12">
                ...
                <p className="text-justify">Founded in 2009 a s part of the Lexicon Group of Institutes (est. 2006),
                    ...
                    Lexicon ecosystem i s a holistic platform for talent development.</p>
                <br />
                <p className="text-justify">At Lexicon MILE, our philosophy-One Student at a Time-has evolved into the
                    global positioning of, " A
                    Mentor Every MILE." W e invest deeply in the personal journey of each learner, combining academic
                    rigor, mentorship from industry leaders, and global exposure t o shape Day Zero
        ...
        <div className="flex flex-wrap items-center pt-8 lg:pt-12">
            ...
            <div className="w-full lg:w-1/2 lg:ps-12">
                ...
                <p className="text-justify">The University of South Wales, UK, brings over 100 years of academic
                    excellence to the partnership. Accredited by the Privy Council and assured b y the Quality Assurance
